import { TrendingUp, BarChart3, Star, Settings, Menu, User, LogOut, Briefcase, LayoutGrid, Trophy, Wallet, Target, BookOpen, Receipt } from 'lucide-react';
...
export type TabId = 'dashboard' | 'watchlist' | 'journal' | 'portfolio' | 'paper' | 'tax' | 'screener' | 'betting' | 'strategy' | 'stats' | 'settings';
...
const tabs = [
  ...
  { id: 'tax' as const, label: 'Skatt', icon: Receipt },
